...
def create_child_proportions():
    ...
    bone_scales = {
        ...
        'LeftArm': Vector((1.0, 0.8, 1.0)),
        'RightArm': Vector((1.0, 0.8, 1.0)),
        'LeftShoulder': Vector((0.8, 0.8, 0.8)),
        'RightShoulder': Vector((0.8, 0.8, 0.8)),
        'LeftForeArm': Vector((1.1, 0.7, 1.1)),
        'RightForeArm': Vector((1.1, 0.7, 1.1)),
        ...
        'LeftUpLeg': Vector((0.8, 0.65, 0.8)),
        'RightUpLeg': Vector((0.8, 0.65, 0.8)),
