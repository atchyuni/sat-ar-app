...
public class FacialSwitcher : MonoBehaviour
{
    ...
    public GameObject Avatar
    {
        ...
        set
        {
            ...
            if (avatar != null)
            {
                Transform headTransform = FindDeepChild(avatar.transform, "AvatarHead");
                ...
                if (headTransform != null)
                {
                    ...
                    if (skin == null)
                    {
                        Debug.LogError("missing mesh renderer component", headTransform.gameObject);
                    }
                }
                else
                {
                    Debug.LogError("unable to find head mesh on avatar", avatar);
                }
            }
        }
    }
    ...
    // helper function which recursively searches for child transform by name
